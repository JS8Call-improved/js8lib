...
- Qt6 v6.6.3, Hamlib v4.6.4, libusb-1.0.29 and Boost 1.88.0 are obtained as submodules with `git submodule update --init --recursive' by
running the BUILD.sh script for MacOS
...
-Note: the script will check out the 6.8.1 Qt branch by default. If you wish to build a different version of Qt, modify the script before running it
to check out the version of Qt that you want.
